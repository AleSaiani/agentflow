...
[![version](https://img.shields.io/badge/version-1.0.0--beta.9-blue)](CHANGELOG.md)
...
`1.0.0-beta.9`. Primitives, the workflow layer (WORKFLOW.md, params, fork, schema validation, stage
