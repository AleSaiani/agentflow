# fake-repo — intentional-bug corpus for /agentflow:audit validation

This is **not real code**. It exists solely to exercise the `/agentflow:audit`
...
## Expected /agentflow:audit behavior
